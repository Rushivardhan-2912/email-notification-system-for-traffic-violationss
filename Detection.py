    ...
    def __init__(self, top=None):
            ...
            try:
                ...
                if noOfPassengers != "":
                    if int(noOfPassengers) >= 3:
                        ...
                        challanBreaked = (
                            challanBreaked
                            + "<br><br><b>There were 3 Passengers in your vehicle (1000 Rs)</b>"
                        )

                message = (
                    "Hi, User<br><br>You have break the following traffic rules "
                    + challanBreaked
                    + "<br><br>Now you have to pay <b>"
                    + str(amount)
                    + "Rs.</b> as Challan."
                )
                data = open(self.listFiles[self.ChallanImg]).read().split("\n")
                self.yag.send(
                    to="rushivardhan10@gmail.com",
                    subject="Traffic Rule Challan",
                    contents=message,
                    attachments=data[0],
                )
                self.yag.close()
        ...
        def generate_excel():
            ...
            with open(filename, "w", newline="") as file:
                ...
                writer.writerow(
                    ["Helmet Status", "LP Status", "LP Number", "No of passengers"]
                )
                ...
                for file in listFiles:
                    try:
                        ...
                        # Write row to file
                        writer.writerow(
                            [helmet_status, lp_status, lp_number, num_passengers]
                        )
        ...
        font15 = (
            "-family {Schadow BT} -size 32 -weight normal -slant "
            "roman -underline 0 -overstrike 0"
        )
        font16 = (
            "-family {Schadow BT} -size 19 -weight normal -slant "
            "roman -underline 0 -overstrike 0"
        )
        font17 = (
            "-family {Segoe UI} -size 19 -weight normal -slant "
            "roman -underline 0 -overstrike 0"
        )
        font19 = (
            "-family {Segoe UI} -size 19 -weight normal -slant "
        ...
        self.cmbPlateStatus.place(
            relx=0.557, rely=0.204, relheight=0.061, relwidth=0.35
        )
        ...
        self.cmbHelmetStatus.place(
            relx=0.557, rely=0.048, relheight=0.063, relwidth=0.347
        )
        ...
        self.txtPassengers.place(relx=0.55, rely=0.47, height=49, relwidth=0.357)
        ...
        self.txtPlateNumber.place(relx=0.557, rely=0.354, height=45, relwidth=0.35)
